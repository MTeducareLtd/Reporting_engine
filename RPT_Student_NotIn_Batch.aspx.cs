...
public partial class RPT_Student_NotIn_Batch : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            if (ddlLMSProduct.SelectedIndex== null)
            {
            ...
            if (ddlStandard.SelectedIndex == null)
            {
            ...
            try
            {
                ds = Report.Get_notinbatch_Report(ddlDivision.SelectedValue, CenterCode, "", ddlAcadYear.SelectedValue, Lmsproductcode);
