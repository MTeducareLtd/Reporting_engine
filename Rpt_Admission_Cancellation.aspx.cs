...
public partial class Rpt_Admission_Cancellation : System.Web.UI.Page
{
       #region PageLoad
    ...
    private void FillGrid()
    {
        try
        {
            ...
            string Status = "";
            Status = ddlReason.SelectedValue;
            ...
            AcadYear = ddlAcademicYear.SelectedItem.Text;


            DataSet dsGrid = ProductController.Get_Admssioncancelationdata(DivisionCode, AcadYear, CenterCode,Status);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        Response.Buffer = true;
        Response.ContentType = "application/vnd.ms-excel";
        string filenamexls1 = "Student_Admission_Cancel_Details_" + DateTime.Now + ".xls";
        Response.AddHeader("Content-Disposition", "inline;filename=" + filenamexls1);
        HttpContext.Current.Response.Charset = "utf-8";
        HttpContext.Current.Response.ContentEncoding = System.Text.Encoding.GetEncoding("windows-1250");
        //sets font
