<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true"
    CodeFile="Rpt_Lead_Summary.aspx.cs" Inherits="Rpt_Lead_Summary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Lead Summary Report<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                        ...
                        <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td style="text-align: center">
                                            <asp:Label ID="lblFresh" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"FRESH")%>' />
                                        </td>
                                        <td style="text-align: center">
                                            <asp:Label ID="lblCold" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"COLD")%>' />
                                        </td>
                                         <td style="text-align: center">
                                            <asp:Label ID="lblWarm" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"WARM")%>' />
                                        </td>
                                        <td style="text-align: center">
                                            <asp:Label ID="lblHOT" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"HOT")%>' />
                                        </td>
                                        <td style="text-align: center">
                                            <asp:Label ID="lblLost" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LOST")%>' />
                                         </td>
                                        <td style="text-align: center">
