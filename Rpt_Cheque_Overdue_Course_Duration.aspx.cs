...
public partial class Rpt_Cheque_Overdue_Course_Duration : System.Web.UI.Page
{
    ...
    private void BindStream()
    {
        ...
        string UserID = cookie.Values["UserID"];
        string UserName = cookie.Values["UserName"];
       // DataSet ds = Reporting.GetStreamby_Center_AcademicYear_All(ddlcenter.SelectedValue, ddlacademicyear.SelectedValue, ddlcompany.SelectedValue, ddldivision.SelectedValue,ddlzone.SelectedValue);
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        ...
        string filenamexls1 = "Cheque_Overdue_Course_Duration_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='15'>Cheque Overdue Course Report</TD></TR>");
        Response.Charset = "";
    ...
    {
        Response.Redirect("Rpt_Cheque_Overdue_Course_Duration.aspx");
    }
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds1 = Reporting.GetChequeOverdueCourseDuration(CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID, stream, ddlcondtion.SelectedValue);
    ...
    private void BindCondtion()
    {
        List<string> condition = new List<string>();
        //condition.Add("<");
        condition.Add(">");
        condition.Add("=");
        ddlcondtion.DataSource = condition;
