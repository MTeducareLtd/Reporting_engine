...
public partial class rpt_Campaign_Followup_Lost_Contact_Summary : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = ProductController.GET_CAMPAIGN_Followup_Lost_Contact_Summary(1, UserID, ddlcampaignacadyear.SelectedValue, Camapign_id);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 =  "Campaign_Followup_Lost_Contact_Summary_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='9'>Campaign Followup Lost Contact Summary</TD></TR>");
        Response.Charset = "";
