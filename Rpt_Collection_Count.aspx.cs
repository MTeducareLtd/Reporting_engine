...
public partial class Rpt_Collection_Count : System.Web.UI.Page
{
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        ...
        string filenamexls1 = "Collection_count_streamwise_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri;text-decoration-color: White; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='26'>Collection Count Stream Wise Report </TD></TR>");
        Response.Charset = "";
