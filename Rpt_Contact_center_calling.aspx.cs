...
public partial class Rpt_Contact_center_calling : System.Web.UI.Page
{            
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Calling Summary" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='10'> Calling Summary</TD></TR>");
        Response.Charset = "";
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        if (DateRange.Length != 0)
        {
            ...
            DataSet ds1 = Reporting.GetCentreCallingReport1(1, ddlCampaign.SelectedValue, txtuser.Text, a1, a2);
