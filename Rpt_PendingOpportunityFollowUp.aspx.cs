...
public partial class Rpt_PendingOpportunityFollowUp : System.Web.UI.Page
{
    int runningTotal = 0;
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        DataSet ds1 = Reporting.GetOpportunitySummary("2", CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID);
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        ...
        string filenamexls1 = "PendingOpportunityFollowUpRpt_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='4'>Pending Opportunity FollowUp Report</TD></TR></TR><TR><TD Colspan='2'><b>Company : " + ddlcompany.SelectedItem.ToString() + "</b></TD><TD Colspan='2'><b>Division : " + ddldivision.SelectedItem.ToString() + "</b></TD></TR><TR></TR>");
        Response.Charset = "";
