<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true" CodeFile="ContactCenter_Lead_Report.aspx.cs" Inherits="ContactCenter_Lead_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                  Contact Center Lead Report<span class="divider"></span></h5>
           </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                            ...
                            <div id="AdmissionCount" class="tab-pane in active">
                                ...
                                <HeaderTemplate>                                                             
                                    ...
                                    <tr>
                                       ...
                                       <%-- <th style="width: 10%; text-align: center;">
                                            LEAD GENERATED BY CONTACT CENTER--%>
                                        <%--</th>--%>
                                       <%-- <th style="width: 10%; text-align: center;">
                                            Cours--%>
                                        <%--</th>
                                ...
                                <ItemTemplate>
                                  <tr class="odd gradeX">
                                        ...
                                        <td style="text-align: left;">
                                            <asp:Label ID="LEADGENERATEDBYCONTACTCENTER" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LEADGENERATEDBYCONTACTCENTER")%>' />
                                            </td>                              
                                      </tr>
                                </ItemTemplate>
