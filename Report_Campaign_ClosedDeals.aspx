<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true"
    CodeFile="Report_Campaign_ClosedDeals.aspx.cs" Inherits="Report_Campaign_ClosedDeals" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Campaign Closed Deals Report<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                    ...
                    <ItemTemplate>
                            ...
                            <td style="text-align: left;">
                             ...
                             <td style="text-align: center;">
                                <asp:Label ID="lblTotalAccount" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TotalCampaignAccountStud")%>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:Label ID="lblTotalAccountValue" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TotalCampaignAccountStudValue")%>' />
                            </td>
                    </ItemTemplate>
                </asp:DataList>
<%--
