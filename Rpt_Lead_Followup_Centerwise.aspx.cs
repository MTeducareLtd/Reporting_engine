...
public partial class Rpt_Lead_Followup_Centerwise : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ...
                ds = Report.Get_Lead_Followup_centerwise_Report(1, ddlAcadYear.SelectedValue, CreatedBy);
    ...
    {        
        ...
        string filenamexls1 = "Report_Lead_Followup_Centerwise_" + DateTime.Now + ".xls";
