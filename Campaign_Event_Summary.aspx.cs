...
public partial class Campaign_Event_Summary : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = ProductController.GET_CAMPAIGN_Event_Summary(1, CreatedBy, ddlcampaignacadyear.SelectedValue, "", "", Camapignid);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        {
            filenamexls1 = "Campaign_Event_Summary" + DateTime.Now + ".xls";
        }
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='5'>Campaign_Event_Summary</TD></TR>");
        Response.Charset = "";
