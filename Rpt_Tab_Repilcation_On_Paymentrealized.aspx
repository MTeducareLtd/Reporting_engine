<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true" CodeFile="Rpt_Tab_Repilcation_On_Paymentrealized.aspx.cs" Inherits="Rpt_Tab_Repilcation_On_Paymentrealized" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                   TAB Replication On Payment Realized <span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>
                             ...
                             <td style="text-align: left;">
                                <asp:Label ID="Lblzone" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Zonename")%>' />
                            </td> 
                            <td style="text-align: left;">
                         ...
                         <%--   <td style="text-align: Center;">
                            ...
                            <td style="text-align: left;">
                                <asp:Label ID="lblBatch_Code" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"date")%>' />
                            </td>
                            <td style="text-align: left;">
                                <asp:Label ID="lblBatchName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"admissonstatus")%>' />
                            </td>
                            <td style="text-align: left;">
                                <asp:Label ID="lblpaymode" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Pay_Mode")%>' />
                            </td>
                            <td style="text-align: left;">
                                <asp:Label ID="lblBatchShortName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"amountclearedtilldate" +
    "" +
    "")%>' />
                            </td>
                            <td style="text-align: left;">
                                <asp:Label ID="Label6" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"BatchName")%>' />
                            </td>
