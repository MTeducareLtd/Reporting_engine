...
public partial class Rpt_OpportunityVsAdmission : System.Web.UI.Page
{
    int runningTotal = 0;
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        DataSet ds1 = Reporting.GetOpportunityVsAdmissionSummary("1", CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID);
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        ...
        string filenamexls1 = "OpportunityVsAdmissionRpt_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='5'>Opportunity VS Admission Report</TD></TR></TR><TR><TD Colspan='2'><b>Company : " + ddlcompany.SelectedItem.ToString() + "</b></TD><TD Colspan='3'><b>Division : " + ddldivision.SelectedItem.ToString() + "</b></TD></TR><TR></TR>");
        Response.Charset = "";
