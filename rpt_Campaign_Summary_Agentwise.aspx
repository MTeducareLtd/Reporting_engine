<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    CodeFile="rpt_Campaign_Summary_Agentwise.aspx.cs" Inherits="rpt_Campaign_Summary_Agentwise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Campaign Summary Agentwise<span class="divider"></span>
                </h5>
            </li>
        </ul>
        <div id="nav-search">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>                        
                        ...
                        <td style="text-align: center;">
                         ...
                         <td style="text-align: center;">
                            <asp:Label ID="lblNotCalledEvenOnce" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"NotCalledEvenOnce")%>' />
                        </td>
                        <td style="text-align: center;">
                        ...
                        <td style="text-align: center;">
                            <asp:Label ID="lblAvailableLeads" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AvailableLeads")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblAvailableOpportunity" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AvailableOpportunity")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblAvailableAdmisison" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AvailableAdmisison")%>' />
                        </td>
                        <td style="text-align: center;">
