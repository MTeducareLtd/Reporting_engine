...
public partial class Rpt_Tab_Repilcation_On_Paymentrealized : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = Report.Get_studentbypayment_Report(1, CreatedBy, ddlDivision.SelectedValue, CenterCode, ddlStandard.SelectedValue, ddlAcadYear.SelectedValue, ddlLMSProduct.SelectedValue, "All");
