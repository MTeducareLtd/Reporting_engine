...
public partial class Rpt_Conversion_Contacts_To_Lead : System.Web.UI.Page
{
    ...
    private void Standard()
    {
       ...
       // BindListBox(ddlStandard, ds, "Description", "ID");
        BindDDL(ddlStandard, ds, "Description", "ID");
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ...
                {
                    ds = Report.Get_Conversion_Contacts_To_Lead_Locationwise_Report(1, ddlAcadYear.SelectedValue, StandardCode, CreatedBy);
                }
                else if (ddlReport.SelectedValue == "2")
                {
                    ds = Report.Get_Conversion_Contacts_To_Lead_Institutewise_Report(1, ddlAcadYear.SelectedValue, StandardCode, CreatedBy);
                }
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        //    if (ddlStandard.Items[cnt].Selected == true)
        //    {
        //        Standard = Standard + ddlStandard.Items[cnt].ToString() + ",";
        //    }
        //}
        //Standard = Standard.Substring(0, Standard.Length - 1);
        Standard = ddlStandard.SelectedItem.ToString();
        Response.Clear();
        ...
        if (ddlReport.SelectedValue == "1")
        {
            filenamexls1 = "Report_Conversion_Contacts_ToLead_Locationwise_" + DateTime.Now + ".xls";
        }
        else if (ddlReport.SelectedValue == "2")
        {
            filenamexls1 = "Report_Conversion_Contacts_ToLead_Institutewise_" + DateTime.Now + ".xls";
        }
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'><TR style='color: #fff; background: black;text-align:center;'><TD>YEAR OF PASSING-" + ddlAcadYear.SelectedItem.ToString() + "</TD><TD>STANDARD-" + Standard + "</TD></TR>");
        Response.Charset = "";
