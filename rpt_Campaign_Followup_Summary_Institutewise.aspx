<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    CodeFile="rpt_Campaign_Followup_Summary_Institutewise.aspx.cs" Inherits="rpt_Campaign_Followup_Summary_Institutewise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Campaign Followup Summary- Institutewise <span class="divider"></span>
                </h5>
            </li>
        </ul>
        <div id="nav-search">
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                            <b style="width: 15%;">Campaign Name</b> 
                        </th>
                        ...
                        <th style="width: 10%; text-align: center;">
                            Next 7 day's Followup
                        </th>
                        <th style="width: 10%; text-align: center;">
                            Prev 7 day's Followup
                         </th>
                        <th style="width: 10%; text-align: center;">
                            Last 50 Followup
                    </HeaderTemplate>
                    <ItemTemplate>                        
                        ...
                        <td style="text-align: left;">
                            <asp:Label ID="lblInstitution_Description" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Institution_Description")%>' />
                        </td>
                        <td style="text-align: left;">
