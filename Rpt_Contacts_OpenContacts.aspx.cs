...
public partial class Rpt_Contacts_OpenContacts : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = Report.Get_Contact_LocationStandardBoardWiseOpenContacts_Report(1, ddlAcadYear.SelectedValue, StandardCode, BoardCode, CreatedBy);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Report_Conversion_Contacts_To_Lead_" + DateTime.Now + ".xls";
