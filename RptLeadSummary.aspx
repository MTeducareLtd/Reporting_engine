<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="RptLeadSummary.aspx.cs" Inherits="RptLeadSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Lead Summary<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                ...
                                <asp:DataList ID="dlLeadSummary" CssClass="table table-striped table-bordered table-hover"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td style="text-align: center">
                                            <asp:Label ID="lblHotCount" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Hot")%>' />
                                        </td>
                                         <td style="text-align: center">
                                            <asp:Label ID="lblWarmCount" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Warm")%>' />
                                        </td>  
                                        <td style="text-align: center">
                                            <asp:Label ID="lblFreshCount" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Fresh")%>' />
                                        </td>
                                        <td style="text-align: center">
                                            <asp:Label ID="lblColdCount" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Cold")%>' />
                                        </td>                                                                             
                                        <td style="text-align: center">
                                            <asp:Label ID="lblLostCount" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Lost")%>' />
                                        </td>
                                        <td style="text-align: center">
