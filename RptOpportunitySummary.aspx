<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="RptOpportunitySummary.aspx.cs" Inherits="RptOpportunitySummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Opportunity Summary<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                ...
                                <asp:DataList ID="dlLeadSummary" CssClass="table table-striped table-bordered table-hover"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td style="text-align: center">
                                            <asp:Label ID="lblContact_Established" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Contact_Established")%>' />
                                        </td>
                                         <td style="text-align: center">
                                            <asp:Label ID="lblQualified" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Qualified")%>' />
                                        </td>  
                                        <td style="text-align: center">
                                            <asp:Label ID="lblProduct_Demonstration" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Product_Demonstration")%>' />
                                        </td>
                                        <td style="text-align: center">
                                            <asp:Label ID="lblProposal" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Proposal")%>' />
                                        </td>                                                                             
                                        <td style="text-align: center">
                                            <asp:Label ID="lblNegotiation" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Negotiation")%>' />
                                        </td>
                                        <td style="text-align: center">
                                            <asp:Label ID="lblClosed_Won" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Closed_Won")%>' />
                                        </td>
                                        <td style="text-align: center">
                                            <asp:Label ID="lblClosed_Lost" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Closed_Lost")%>' />
                                        </td>
                                        <td style="text-align: center">
