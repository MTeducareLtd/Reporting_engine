<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true"
    CodeFile="Rpt_Replication_Report.aspx.cs" Inherits="Rpt_Replication_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Replication Report<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                                    ...
                                                    <table style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList runat="server" ID="ddlDivision" Width="215px" data-placeholder="Select Divison Name" AutoPostBack="true" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged"
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList runat="server" ID="ddlAcadYear" Width="215px" data-placeholder="Select Acad Year" AutoPostBack="true" OnSelectedIndexChanged="ddlAcadYear_SelectedIndexChanged"
                                                                    CssClass="chzn-select" />
                                                            </td>                                                            
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList runat="server" ID="ddlStandard" Width="215px" data-placeholder="Select Standard Name" AutoPostBack="true" OnSelectedIndexChanged="ddlStandard_SelectedIndexChanged"
                                                                    CssClass="chzn-select" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList runat="server" ID="ddlCenter" Width="215px" data-placeholder="Select Center Name" 
                                                                    CssClass="chzn-select" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList runat="server" ID="ddlLMSProduct" Width="215px" data-placeholder="Select LMS Product" AutoPostBack="true" OnSelectedIndexChanged="ddlLMSProduct_SelectedIndexChanged"
                                                                    CssClass="chzn-select" />
                                                            </td>
                                                        </tr>
                                                    </table>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td style="text-align: right" class="span2">
                                    <asp:LinkButton runat="server" ID="lnkpdfprint2" ToolTip="ICard Print" class="btn-small btn-warning icon-2x icon-download-alt"
                                        Height="25px" OnClick="PDF2_Click" />
                                    <asp:LinkButton runat="server" ID="lnkpdfprint" ToolTip="PDF Print" class="btn-small btn-success icon-2x icon-download-alt"
                                        Height="25px" OnClick="PDF_Click" />
                    ...
                    <ItemTemplate>
                            ...
                            <td style="text-align: left;">
                             ...
                             <td style="text-align: left;">
                                ...
                                <asp:Label ID="lblImagePath" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem,"ImagePath")%>' />
                            </td>
                            ...
                            <td style="text-align: center;">
                             ...
                             <td style="text-align: Center;">
                                <asp:Label ID="Label7" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"FHandphone1")%>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:Label ID="Label8" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"FHandphone2")%>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:Label ID="Label9" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"FLandline")%>' />
                            </td>
                              <td style="text-align: Center;">
                                <asp:Label ID="Label10" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"MHandphone1")%>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:Label ID="Label11" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"MHandphone2")%>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:Label ID="Label12" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"MLandline")%>' />
                            </td>
                            <td style="text-align: left;">
                                <asp:Label ID="lblstudent_code" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"student_code")%>' />
                            </td>
                             <td style="text-align: left;">
                            ...
                            <td style="text-align: left;">
                                <asp:Label ID="Label6" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"BATCHCREATEDON")%>' />
                            </td>
                            <td style="text-align: left;">
                             ...
                             <td style="text-align: left;">
                                <asp:Label ID="lblmodified" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"modifiedon")%>' />
                            </td>
