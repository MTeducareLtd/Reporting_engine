...
//using Exportxls.BL;
using Encryption.BL;
public partial class Rpt_ECS_Authorization : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
       ...
       // DataSet ds1 = Reporting.GetCollectionCount(Reporttype, Flag2, CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID, stream);
        DataSet ds1 = Reporting.GetECS_Detail(UserID, CompanyCode, DivisionCode, Zone, Center, AcadyearCode, stream, ECSStatusID, "", "1", "");
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        ...
        string filenamexls1 = "ECS_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri;text-decoration-color: White; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='10'>Collection ECS Report </TD></TR>");
        Response.Charset = "";
    ...
    {
        Response.Redirect("rpt_collection_count.aspx");
    }
