<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    CodeFile="Campaign_Event_Summary.aspx.cs" Inherits="Campaign_Event_Summary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Campaign Event Summary - OverAll<span class="divider"></span>
                </h5>
            </li>
        </ul>
        <div id="nav-search">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>
                        ...
                        <td style="text-align: left;">
                            <asp:Label ID="Label1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Event_Name")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblTotalContacts" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ContactTotalCount")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"EventContactCount")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblTotalLeads" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"PresentEventCount")%>' />
                        </td>
