<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    CodeFile="rpt_Campaign_Followup_Lost_Contact_Detailed.aspx.cs" Inherits="rpt_Campaign_Followup_Lost_Contact_Detailed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Campaign Lost Contact Feedback - Detailed<span class="divider"></span>
                </h5>
            </li>
        </ul>
        <div id="nav-search">
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                        <b style="width: 25%;">Camapign Name</b> </th>                        
                    ...
                    <ItemTemplate>
                        ...
                        <td style="text-align: left;">
                            <asp:Label ID="lblLostRemark" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LostRemark")%>' />
                        </td>                 
                    </ItemTemplate>
                </asp:DataList>
            </div>
