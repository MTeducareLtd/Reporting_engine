<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true" CodeFile="ContactCenter_detailed_Report.aspx.cs" Inherits="ContactCenter_detailed_Report" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h4 class="blue">
                 ContactCenter_detailed_lead_Report<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                ...
                <div id="DivResult" runat="server" width="100%" >
                    <div class="tabbable">
                        ...
                        <div class="tab-content" style="border: 1px solid #DDDDDD; overflow: hidden">
                            <div id="AdmissionCount" class="tab-pane in active">
                                ...
                                <HeaderTemplate>                                                             
                                    ...
                                    <thead>
                                    <tr>
                                        <th style="width: 09%; text-align: center;">
                                           <b>Entry Date</b
                                        </th>
                                        <th style="width: 10%; text-align: center;">
                                            Division
                                ...
                                <ItemTemplate>
                                  <tr class="odd gradeX">
                                        ...
                                        <td style="text-align: left;">
                                            <asp:Label ID="lblCENTERNAME1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CENTERNAME")%>' />
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label10" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"studentname")%>' />
                                            </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label8" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"MobileNumber1")%>' />
                                               </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label11" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"MobileNumber2")%>' />
                                        </td>
                                      <td style="text-align: center;">
                                            <asp:Label ID="lblleadsgeneratedby" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"leadsgeneratedby")%>' />
                                        </td>
                                        <td style="text-align: center;">
                                            <asp:Label ID="lblOPPROTUNITY" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"OPPROTUNITY")%>' />
                                        </td>                                        
                                        <td style="text-align: center;">
                                            <asp:Label ID="lblLEADFLOWUP" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LEADFLOWUP")%>' />
                                       </td>
                                       <td style="text-align: center;">
                                            <asp:Label ID="lblOPPORTUNITYFLOW" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"OPPORTUNITYFLOW")%>' />
                                        </td> 
                                        <td style="text-align: center;">
                                            <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"admission")%>' />
                                        </td> 
                                        <td style="text-align: center;">
                                            <asp:Label ID="Label7" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"product")%>' />
                                        </td> 
                                    </tr>
                                </ItemTemplate>
