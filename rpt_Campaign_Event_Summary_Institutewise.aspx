<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    CodeFile="rpt_Campaign_Event_Summary_Institutewise.aspx.cs" Inherits="rpt_Campaign_Event_Summary_Institutewise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Campaign Event Summary - Institutewise<span class="divider"></span>
                </h5>
            </li>
        </ul>
        <div id="nav-search">
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                        <b style="width: 20%;">Campaign Name</b> </th>
                    ...
                    <ItemTemplate>
                        ...
                        <td style="text-align: left;">
                            <asp:Label ID="lblInstituteName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"InstituteName")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblEvent_Name" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Event_Name")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblTotalCampaignContacts" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TotalCampaignContacts")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblTotalEventsContacts" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TotalEventsContacts")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblTotalAttendedContacts" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TotalAttendedContacts")%>' />
                        </td>
