<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    CodeFile="rpt_Campaign_Followup_Lost_Contact_Summary.aspx.cs" Inherits="rpt_Campaign_Followup_Lost_Contact_Summary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Campaign Lost Contact Feedback - Summary<span class="divider"></span>
                </h5>
            </li>
        </ul>
        <div id="nav-search">
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                        <b style="width: 15%;">Camapign Name</b> 
                        </th>                        
                    ...
                    <ItemTemplate>
                            <asp:Label ID="lblCampaign_Name" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Campaign_Name")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblTotalCampaignContacts" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TotalCampaignContacts")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblLostFollowup" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LostFollowup")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblCantAfford" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CantAfford")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblJoinedCompetitors" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"JoinedCompetitors")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblIrrelevant_Or_Duplicate_Contact" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Irrelevant_Or_Duplicate_Contact")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblNot_contactable" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Not_contactable")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblNot_Interested" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Not_Interested")%>' />
                        </td>       
                        <td style="text-align: center;">
                            <asp:Label ID="lblJoined_Other_Stream" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Joined_Other_Stream")%>' />
                        </td>                 
                    </ItemTemplate>
                </asp:DataList>
            </div>
