<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="Rpt_DayWiseOpportunityCount.aspx.cs" Inherits="Rpt_DayWiseOpportunityCount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                   Day Wise Opportunity<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                    ...
                                                                    <span>
                                                                        <input readonly="readonly" class="span12 date-picker" id="txtOPDate" runat="server" type="text"
                    ...
                    <div class="tabbable">                        
                        <div class="tab-content" style="border: 1px solid #DDDDDD; overflow: hidden">
                            <div id="LeadCount" class="tab-pane in active">
                                ...
                                <asp:GridView ID="dlLeadSummary" runat="server" CssClass="table table-striped table-bordered table-hover"
