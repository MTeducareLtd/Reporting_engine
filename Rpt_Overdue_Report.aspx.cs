...
public partial class Rpt_Overdue_Report : System.Web.UI.Page
{
    ...
    private void BindStatus()
    {
        ...
        BindListBox(ddlstatus, ds, "Account_Status_Name", "Account_Status_Name");
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        ...
        string filenamexls1 = "Cheque_Overdue_Report" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='14'>Cheque Overdue Report </TD></TR>");
        Response.Charset = "";
    ...
    {
        Response.Redirect("Rpt_Overdue_report.aspx");
    }
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (DateRange.Length != 0)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Date Range should be less than Current Date');", true);
                // Response.Redirect("rpt_overdue_report.aspx");
                return;
            }
            ...
            DataSet ds1 = Reporting.GetChequeOverDue(CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, a1, a2, UserID, stream);
