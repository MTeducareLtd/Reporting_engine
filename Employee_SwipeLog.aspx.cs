...
public partial class Employee_SwipeLog : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        ...
        //string Multi_RFID = txtrfid.Text;
        //string[] items = Multi_RFID.Split(new char[] { ',', ' ' }, StringSplitOptions.RemoveEmptyEntries);
        //string Multi_RFID = txtrfid.Text; ;
        //string[] values = Multi_RFID.Split(',');
        ...
        DateTime CurrentDate = DateTime.ParseExact(NewCurrentDate, "MM/dd/yyyy", null);
            ...
            DataSet dsGrid = ProductController.GetEmployeeAttendance_SwipeLogDetails(EmployeeName, FromDate, Todate, Rfid);
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "EmployeeSwipeLog" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='7'>Employee Swipe Log </b></TD></TR>");
        Response.Charset = "";
