<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    CodeFile="Campaign_Summary_Institutewise.aspx.cs" Inherits="Campaign_Summary_Institutewise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Campaign Summary- Institutewise <span class="divider"></span>
                </h5>
            </li>
        </ul>
        <div id="nav-search">
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                        <b style="width: 25%;">Campaign Name</b> </th>
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkCampaignName" runat="server" CommandName="Campaign_Detail"
                            CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Campaignid")%>' ToolTip="Campaign Detail">
                            <asp:Label ID="lblCampaignName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Campaign_Name")%>' />
                        </asp:LinkButton></td><td style="text-align: left;">
                            <asp:Label ID="lblTotalContacts" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Institution_Description")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TotalContacts")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblTotalLeads" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Campaignstage")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblTotalOpportunity" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LeadCount")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="lblTotalClosedLeads" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"OppCount")%>' />
                        </td>
                        <td style="text-align: center;">
                            <asp:Label ID="Label1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AccountCount")%>' />
                        </td>
                    </ItemTemplate>
                </asp:DataList>
                <asp:DataList ID="dlGridDisplay1" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                        <b>Campaign Name</b> </th><th style="width: 20%; text-align: center;">
                            Institute Name </th><th style="width: 20%; text-align: center;">
                            Total Contacts </th><th style="width: 20%; text-align: center;">
                            Campaign Stage </th><th style="width: 10%; text-align: center;">
                            Lead Stage </th><th style="width: 10%; text-align: center;">
                            Opportunity Stage </th><th style="width: 10%; text-align: center;">
                            Account </HeaderTemplate><ItemTemplate>
                        <asp:Label ID="lblCampaignName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Campaign_Name")%>' />
