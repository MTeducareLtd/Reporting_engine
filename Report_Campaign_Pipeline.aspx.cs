...
public partial class Report_Campaign_Pipeline : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = Report.GetUser_Role_Campaign(9, CreatedBy, ddlCampaignTypeSearch.SelectedValue, txtCampaignNameSearch.Text.Trim(),"");
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        {
            filenamexls1 = "Campaign_Detail_Pipeline_" + DateTime.Now + ".xls";
        }
        else
        {
            filenamexls1 = "Campaign_PipeLine_" + DateTime.Now + ".xls";
        }
    ...
    protected void dlGridDisplay_ItemCommand(object source, System.Web.UI.WebControls.DataListCommandEventArgs e)
    {
        if (e.CommandName == "Campaign_Detail")
        {
            ...
            try
            {
                ...
                try
                {
                    ds = Report.GetUser_Role_Campaign_Detail(11, CreatedBy,e.CommandArgument.ToString() ,ddlCampaignTypeSearch.SelectedValue, txtCampaignNameSearch.Text.Trim());
