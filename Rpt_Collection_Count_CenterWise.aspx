<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true" CodeFile="Rpt_Collection_Count_CenterWise.aspx.cs" Inherits="Rpt_Collection_Count_CenterWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Collection Report Center Wise<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                        ...
                        <div class="tab-content" style="border: 1px solid #DDDDDD">                            
                                ...
                                <ItemTemplate>
                                  <tr class="odd gradeX">                                       
                                      ...
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label11" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"RobomateContentPrice")%>' />
                                        </td> 
                                       <td style="text-align: left; font-size:10.0pt; font-family:Calibri;">
                                      ...
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label16" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"othercharges")%>' />
                                        </td> 
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
