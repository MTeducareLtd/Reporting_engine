...
public partial class Campaign_Summary : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = ProductController.GET_CAMPAIGN_SUMMARY_REPORT(1, CreatedBy, ddlcampaignacadyear.SelectedValue, "", "", Camapign_id);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='8'>Campaign Summary</TD></TR>");
        Response.Charset = "";
