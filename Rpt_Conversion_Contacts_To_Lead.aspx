<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true"
    CodeFile="Rpt_Conversion_Contacts_To_Lead.aspx.cs" Inherits="Rpt_Conversion_Contacts_To_Lead" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Conversion Contacts To Lead Report<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
                                            ...
                                            <tr>
                                                    ...
                                                    <table style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label2" CssClass="red">Report</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList runat="server" ID="ddlReport" Width="215px" data-placeholder="Select Report" 
                                                                    CssClass="chzn-select" >
                                                                        <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                                                        <asp:ListItem Text="Locationwise" Value="1"></asp:ListItem>
                                                                        <asp:ListItem Text="Institutewise" Value="2"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label14" CssClass="red">Year of Passing</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <%--<asp:ListBox runat="server" ID="ddlStandard"  data-placeholder="Select Standard(s)"
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <div class="row-fluid">
                    <asp:GridView ID="dlGridDisplay" runat="server" Width="100%" EnableEventValidation="false">
                    </asp:GridView>
                       <%--  <asp:DataList ID="dlGridDisplay"
                            runat="server">
                        </asp:DataList>--%>
                </div>
