...
public partial class RPT_Student_BatchCount : System.Web.UI.Page
{
    #region PageLoad
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = Report.Get_batch_Report(ddlDivision.SelectedValue, CenterCode, ddlStandard.SelectedValue, ddlAcadYear.SelectedValue, ddlLMSProduct.SelectedValue);
