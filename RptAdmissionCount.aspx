<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true" EnableEventValidation = "false"  CodeFile="RptAdmissionCount.aspx.cs" Inherits="RptAdmissionCount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">    
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                  Admission  Counts<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content" style="border: 1px solid #DDDDDD; overflow: hidden">
                            <div id="AdmissionCount" class="tab-pane in active">
                                ...
                                <FooterTemplate>
                                   <tr class="odd gradeX"> 
                                        <td colspan="5" style="text-align: center; color: #fff; background: ;"><font color="black"><b>Total</b></font></td>
                                       <td style="text-align: center; color: #fff; background: ;"><asp:Label ID="Label5" ForeColor="DarkBlue" runat="server"/></td>
                                        ...
                                        <td style="text-align: center; color: #fff; background:;"><asp:LinkButton ID="lnkbtn" runat="server" PostBackUrl="~/Rpt_Streamwise_Count.aspx" Font-Underline="True"><asp:Label ID="Label12" ForeColor="DarkBlue" runat="server"/></asp:LinkButton></td></tr></tbody></table></FooterTemplate></asp:Repeater></div></div></div></div><div id="DivPrint" runat="server" visible="true" style="height: 0px; overflow: hidden;">
                                ...
                                <table style="width: 210mm" border="1" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="10%" style="text-align: left; font-size: 9pt; font-family: Arial, Helvetica, sans-serif;" >
                                            Student Name : </td><td width="50%" style="text-align: left; font-size: 9pt; font-family: Arial, Helvetica, sans-serif;">
                                            <asp:Label ID="lblPrint_StudentName" runat="server" Text="" Font-Bold="True" />
                                        </td>
                                        <td width="10%" style="text-align: left; font-size: 9pt; font-family: Arial, Helvetica, sans-serif;">
                                            Roll No : </td><td width="10%" style="text-align: left; font-size: 9pt; font-family: Arial, Helvetica, sans-serif;">
                                            <asp:Label ID="lblPrint_RollNo" runat="server" Text="" Font-Bold="True" />
                                        </td>
                                        <td width="10%" style="text-align: left; font-size: 9pt; font-family: Arial, Helvetica, sans-serif;">
                                            Center : </td><td width="10%" style="text-align: left; font-size: 9pt; font-family: Arial, Helvetica, sans-serif;">
                        ...
                        <tr>
                            <td style="font-family: Arial, Helvetica, sans-serif; font-size: 9pt">
                                <asp:DataList ID="dlPrint_Summary" runat="server" Width="100%" Font-Size="9pt">
                                    <HeaderTemplate>
                                        Test Date </th><th style="width: 10%; text-align: left">
                                            Test Name </th><th style="width: 30%; text-align: left">
                                            Subject </th><th style="width: 10%; text-align: center">
                                            Score </th><th style="width: 10%; text-align: center">
                                            Out of </th><th style="width: 10%; text-align: center">
                                            Percent </th><th style="width: 10%; text-align: center">
                                            Centre Rank </th><th style="width: 10%; text-align: center">
                                        Overall Rank </HeaderTemplate><ItemTemplate>
                                ...
                                <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="border-style: solid; border-width: 1px; text-align: left; font-size: 11pt; font-weight: bold; font-family: arial, Helvetica, sans-serif; width: 100mm;">
                                            Details of Answering </td><td style="text-align: left; font-size: 11pt; font-weight: bold; font-family: arial, Helvetica, sans-serif; width: 110mm;">
                        ...
                        <tr>
                            <td style="font-family: Arial, Helvetica, sans-serif; font-size: 9pt">
                                <asp:DataList ID="dlPrint_Answering" runat="server" Width="100%" Font-Size="9pt">
                                    <HeaderTemplate>
                                        <left>Test Name</left></th><th style="width: 20%; text-align: left;">
                                            Subject </th><th style="width: 10%; text-align: center;">
                                            Status </th><th style="width: 6%; text-align: center;">
                                            Count </th><th style="width: 18%; text-align: left;">
                                            Que No - Easy </th><th style="width: 18%; text-align: left;">
                                            Que No - Moderate </th><th style="width: 18%; text-align: left;">
                                        Que No - Difficult </HeaderTemplate><ItemTemplate>
                                        <asp:Label ID="lblDLTestName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Test_Name")%>' />
                                        </td>
                                        <td style="text-align: left;">
                                ...
                                <table style="width: 100%" border="1" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="100%" valign="middle" align="left">
                                            Overall Topper </td></tr></table></td></tr><tr>
                            <td style="font-family: Arial, Helvetica, sans-serif; font-size: 9pt">
                                <asp:DataList ID="dlPrint_Topper" runat="server" Width="100%" Font-Size="9pt">
                                    <HeaderTemplate>
                                        <left>Test Name</left></th><th style="width: 20%; text-align: left;">
                                            Subject </th><th style="width: 35%; text-align: left;">
                                            Name of Student </th><th style="width: 25%; text-align: left;">
                                            Centre </th><th style="width: 10%; text-align: center;">
                                        Score </HeaderTemplate><ItemTemplate>
                                        <asp:Label ID="lblDLTestName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Test_Name")%>' />
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="lblDLSubject" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Subject_Name")%>' />
