<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true" CodeFile="Rpt_Studentdata.aspx.cs" Inherits="Rpt_Studentdata" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">    
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                  Student Count<span class="divider"></span></h5>
            </li>
        </ul>
        <%--<div id="nav-search">
            <!-- /btn-group -->
