...
public partial class Report_Campaign_Agent_Performance : System.Web.UI.Page
{
    ...
    private void BindCampaignDetail()
    {
        ...
        ddlCampaignNameSearch.DataSource = ds.Tables[0];
        ddlCampaignNameSearch.DataTextField = "Campaign_Name";
        ddlCampaignNameSearch.DataValueField = "Campaign_Id";
        ddlCampaignNameSearch.DataBind();
        //ddlCampaignNameSearch.Items.Insert(0, "Select");
        ddlCampaignNameSearch.Items.Insert(0, "");
        ddlCampaignNameSearch.Items.Insert(1, "All");
        ddlCampaignNameSearch.SelectedIndex = 0;
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = Report.GetUser_Role_Campaign_Detail(13, CreatedBy,ddlCampaignNameSearch.SelectedValue, "", "");
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlCampaignNameSearch.SelectedIndex == 0)
            {
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Campaign_Agent_Performance_" + DateTime.Now + ".xls";
