...
namespace ShoppingCart.BL
{
    public class UserController
    {
        ...
        public static void Insertapplog(string Userid, string Module_Name, string Description, string Ip_address, string IP_Name)
        {
            ...
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_Application_Log", p1, p2, p3, p4, p5);
        }
