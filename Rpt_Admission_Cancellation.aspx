<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Rpt_Admission_Cancellation.aspx.cs" Inherits="Rpt_Admission_Cancellation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Admission Cancellation Details<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
        ...
        <div class="row-fluid">
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label8" CssClass="red">Status</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="ddlReason" Width="215px" data-placeholder="Select Reason" runat="server">
                                                                    <asp:ListItem Value="2">All</asp:ListItem>
                                                                    <asp:ListItem Value="0">Approval Pending</asp:ListItem>
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>
                        <asp:Label ID="lblDivision" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Zone_Name")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblcenter" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CenterName")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblstream" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"StudentName")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblacadyear" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Sbentrycode")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lbloppdate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Stream")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="Label4" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Handphone1")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Handphone2")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="Label3" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Request_date")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lbladmdate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CenterRemark")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="Label2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"[Cancelled Reason]")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="Label11" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"[RefundApplied]")%>' />
                        </td>
                        <td style="text-align: left;">
