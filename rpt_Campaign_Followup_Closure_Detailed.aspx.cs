...
public partial class rpt_Campaign_Followup_Closure_Detailed : System.Web.UI.Page
{
    ...
    protected void ddlReportType_SelectedIndexChanged(object sender, System.EventArgs e)
    {
        ...
        {
            Response.Redirect("rpt_Campaign_Followup_Closure_Summary.aspx");
        }
        else if (ddlReportType.SelectedValue == "Detailed")
        {
            Response.Redirect("rpt_Campaign_Followup_Closure_Detailed.aspx");
        }
    }
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                //ds = ProductController.GET_CAMPAIGN_Followup_Lost_Contacts_Detailed(1, UserID, ddlcampaignacadyear.SelectedValue, Camapign_id);
                ds = ProductController.GET_CAMPAIGN_Followup_Closure_Detailed(1, UserID, ddlcampaignacadyear.SelectedValue, Camapign_id);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 =  "Campaign_Followup_Closure_Remarks_Detailed_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1' borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='8'>Campaign Followup Closure Remarks Detailed</TD></TR>");
        Response.Charset = "";
