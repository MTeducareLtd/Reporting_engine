...
public partial class Rpt_Get_StudentDetails : System.Web.UI.Page
{
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='14'>Student Details Report </b></TD></TR>");
        Response.Charset = "";
    ...
    {
        Response.Redirect("Rpt_Get_StudentDetails.aspx");
    }
}