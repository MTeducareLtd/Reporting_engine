...
public partial class Rpt_CampaignfollowUp_ : System.Web.UI.Page
{
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='8'> Calling Summary</TD></TR>");
        Response.Charset = "";
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        if (DateRange.Length != 0)
        {
            ...
            DataSet ds1 = Reporting.GetCentreCallingReport(1, ddlCampaign.SelectedValue, a1, a2);
