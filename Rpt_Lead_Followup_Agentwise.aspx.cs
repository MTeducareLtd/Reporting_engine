...
public partial class Rpt_Lead_Followup_Agentwise : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ...
                ds = Report.Get_Lead_Followup_Agentwise_Report(1, ddlAcadYear.SelectedValue, CreatedBy);
    ...
    {        
        ...
        string filenamexls1 = "Report_Lead_Followup_Agentwise_" + DateTime.Now + ".xls";
