...
//using Exportxls.BL;
using Encryption.BL;
public partial class Rpt_Student_LMS : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (DateRange.Length != 0)
        {
            ...
            //DataSet ds1 = Reporting.GetStudentDetails(reportype, flag, CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID, stream);
            DataSet ds1 = Reporting.GetStudentLMSData(reportype, flag, CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID, stream,fromdate,todate);
        ...
        else
        {
            string a1 = "";
            string a2 = "";
            DataSet ds1 = Reporting.GetStudentLMSData(reportype, flag, CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID, stream,a1,a2);
            if (ds1.Tables[0].Rows.Count > 0)
            {
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Student_Details_Rpt_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='15'>Student Details Report </b></TD></TR>");
        Response.Charset = "";
    ...
    {
        Response.Redirect("Rpt_Student_LMS.aspx");
