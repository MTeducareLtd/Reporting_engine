...
public partial class rpt_Campaign_Followup_Lost_Contact_Detailed : System.Web.UI.Page
{
    ...
    protected void ddlReportType_SelectedIndexChanged(object sender, System.EventArgs e)
    {
        ...
        {
            Response.Redirect("rpt_Campaign_Followup_Lost_Contact_Summary.aspx");
        }
        else if (ddlReportType.SelectedValue == "Detailed")
        {
            Response.Redirect("rpt_Campaign_Followup_Lost_Contact_Detailed.aspx");
        }
    }
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 =  "Campaign_Followup_Lost_Contact_Detailed_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='6'>Campaign Followup Lost Contact Detailed</TD></TR>");
        Response.Charset = "";
