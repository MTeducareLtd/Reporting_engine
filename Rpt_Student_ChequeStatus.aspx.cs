...
public partial class Rpt_Student_ChequeStatus : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        DateRange = id_date_range_picker_1.Value;
            ...
            DataSet ds1 = Reporting.GetStudentCheque_Details(DivisionCode, Center_Code, ddlStatus.SelectedValue, FromDate, ToDate);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Student_ChequeStatus" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='17'>Student Cheque Status</b></TD></TR>");
        Response.Charset = "";
