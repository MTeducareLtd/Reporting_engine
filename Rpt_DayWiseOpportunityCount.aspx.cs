...
public partial class Rpt_DayWiseOpportunityCount : System.Web.UI.Page
{
    int runningTotal = 0;
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        DataSet ds1 = Reporting.GetDayWiseOpportunity("1", CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID, txtOPDate.Value);
        if (ds1 != null)
        {
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        try
        {
            ...
            string filenamexls1 = "DayWiseOpportunityCountRpt_" + DateTime.Now + ".xls";   
