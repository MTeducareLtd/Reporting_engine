...
public partial class Rpt_Lead_Summary : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ...
                ds = Report.Get_Lead_Summary_Report(1, ddlAcadYear.SelectedValue, CreatedBy);
    ...
    {        
        ...
        string filenamexls1 = "Report_Lead_Summary_" + DateTime.Now + ".xls";
