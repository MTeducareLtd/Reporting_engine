<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true" CodeFile="Rpt_Student_LMS.aspx.cs" Inherits="Rpt_Student_LMS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Student LMS Report<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                        ...
                                        <table cellpadding="6" class="table table-striped table-bordered table-condensed">                                            
                                            ...
                                            <tr>
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label14">Admission Date</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                    ...
                                                    <%--<table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label15">Acad Year</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:ListBox runat="server" ID="ListBox2"  data-placeholder="Select Acad Year"
                                                                    CssClass="chzn-select" SelectionMode="Multiple" AutoPostBack="True" OnSelectedIndexChanged="ddlacademicyear_SelectedIndexChanged"  />
                                                            </td>
                                                        </tr>
                                                    </table>--%>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <%--<table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                 <asp:Label runat="server" ID="Label16">Stream</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:ListBox runat="server" ID="ListBox3"  data-placeholder="Select Stream"
                                                                    CssClass="chzn-select" SelectionMode="Multiple" AutoPostBack="True"  />
                                                            </td>
                                                        </tr>
                                                    </table>--%>
                            ...
                            <div id="AdmissionCount" class="tab-pane in active">
                                ...
                                <table id="simple-table" class="table table-striped table-bordered table-hover  Table2" border="1" style="border-collapse:collapse" width="100%">                                    
                                    ...
                                    <tr>                                       
                                        ...
                                        <th >Center</th>                                        
                                        <th>Stream Name</th>
                                        <th>Products to be Installed</th>
                                ...
                                <ItemTemplate>
                                  <tr class="odd gradeX">   
                                      ...
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri;">
                                            <asp:Label ID="Label13" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Adm_date")%>' />
                                        </td>
                                       <td style="text-align: left; font-size:10.0pt; font-family:Calibri;">
                                      ...
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                       ...
                                       <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label20" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"student_code")%>' />
                                        </td>
                                       <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label5" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Student Name")%>' />
                                        </td>
                                        <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label7" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Handphone1")%>' />
                                        </td>
                                       <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label15" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Emailid")%>' />
                                        </td>
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label8" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"pemailid")%>' />
                                        </td>
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label9" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"pmobileno")%>' />
                                        </td>
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label12" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"residential address")%>' />
                                        </td>
                                    </tr>                                    
                                </ItemTemplate>
                                <FooterTemplate>
