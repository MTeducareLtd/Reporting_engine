<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    CodeFile="Employee_Attendance_Log.aspx.cs" Inherits="Employee_Attendance_Log" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Employee Attendance log - Detailed<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                            ...
                                            <ContentTemplate>
                                                    ...
                                                    <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="border-style: none; text-align: left; width: 60%;">
                                                                        <input readonly="readonly" runat="server" class="id_date_range_picker_1 span8" name="date-range-picker"
                                                                            id="txtperiodCalendr" placeholder="Date Search" data-placement="bottom" data-original-title="Date Range"  />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        <td class="span4" style="text-align: left">
                                                            <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                                <tr>
                                                                    <td style="border-style: none; text-align: left; width: 40%;">
                                                                        <asp:Label runat="server" ID="lblEmployeeNm">Employee Name</asp:Label>
                                                                    </td>
                                                                    <td style="border-style: none; text-align: left; width: 60%;">
                                                            ...
                                                            <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                                <tr>
                                                                    <td style="border-style: none; text-align: left; width: 50%;">
                                                                        <asp:Label runat="server" ID="lblrfid" ForeColor="Red">Employee Code</asp:Label>
                                                                    </td>
                                                                    <td style="border-style: none; text-align: left; width: 50%;">
                                                ...
                                                <div class="well" style="text-align: center; background-color: #F0F0F0">
                                                    ...
                                                    <asp:ValidationSummary ID="ValidationSummary2" runat="server" DisplayMode="BulletList"
                                                        HeaderText="Following error occurs:" ShowMessageBox="true" ShowSummary="False" />
                                                </div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right" class="span2">
                                            <asp:LinkButton runat="server" ID="Back" ToolTip="Back" class="btn btn-danger btn-small"
                                                Height="20px" s OnClick="Back_Click"><i class="icon-reply icon-2x icon-only"></i></asp:LinkButton>
                            ...
                            <div class="tabbable">
                                ...
                                <div class="tab-content" style="border: 1px solid #DDDDDD; overflow: auto">
                                            ...
                                            <tr>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label2">Employee Name</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:Label ID="lblEmployeeNM1" runat="server" Text=""></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label3">Employee Code</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:Label ID="lblrfid2" runat="server" Text=""></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                    ...
                                    <div class="tab-content" style="border: 1px solid #DDDDDD; overflow: hidden">
                                        <div id="Div1" class="tab-pane in active">
                                        </div>
                                        <div id="ACountPendingandConfirm" class="container-fluid">
                                            ...
                                            <asp:Repeater ID="Teacherattendance" runat="server">
                                                <HeaderTemplate>
                                                    <table id="simple-table" class="table table-striped table-bordered table-hover  Table2"
                                                ...
                                                <ItemTemplate>
                                                    <tr class="odd gradeX">
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label13" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Log_Date")%>' />
                                                        </td>
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label10" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"RFID_Card_ID")%>' />
                                                        </td>
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="lblCenter1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"User_Display_Name")%>' />
                                                        </td>
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label26" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Device_Name")%>' />
                                                        </td>
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label20" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"InTime")%>' />
                                                        </td>
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"OutTime")%>' />
                                                        </td>
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label4" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TotalTime")%>' />
                                                        </td>
                                                    <%--      <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label6" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Transfer_To_Portigo")%>' />
                                                        </td>
                                                          <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label7" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Uploaded_On")%>' />
                                                        </td>--%>
                                                    </tr>
                                                </ItemTemplate>
                                                <FooterTemplate>
