...
public partial class ContactCenter_detailed_Report : System.Web.UI.Page
{
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Contact Center Detailed Lead Report" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='9'>Contact Center Detailed Lead Report</TD></TR>");
        Response.Charset = "";
         ...
         
    {
        ...
        if (DateRange.Length != 0)
        {
            ...
            DataSet ds1 = Reporting.GetLeaddetails(CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, a1, a2);
