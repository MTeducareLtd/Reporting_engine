...
//using Exportxls.BL;
public partial class Rpt_Opportunity_Details_Zonewise : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds1 = Reporting.GET_OPPORTUNITY_DETAILS_ZONEWISE(Zonecode, DivisionCode, FromDate, ToDate);
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Opportunity Details Zone Wise" +' '+ DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='9'>Opportunity Details Zone Wise</TD></TR>");
        Response.Charset = "";
    ...
    protected void Repeater1_ItemCommand(object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "com_edit")
        {
            ...
            var Url = "Rpt_Opportunity_DetailsZone_Centerwise.aspx?Zone=" + Server.UrlEncode(Zone_code1) + "&Division=" + Server.UrlEncode(Division_code1) + "&From=" + Server.UrlEncode(FromDate) + "&To=" + Server.UrlEncode(ToDate);
            Response.Redirect(Url);
             //Page.ClientScript.RegisterStartupScript(Page.GetType(), "open_window", 
             //string.Format("void(window.open('{0}', 'child_window'));", "Rpt_Opportunity_DetailsZone_Centerwise.aspx?Zone=" + Server.UrlEncode(Zone_code1) + "&Division=" + Server.UrlEncode(Division_code1) + "&From=" + Server.UrlEncode(FromDate) + "&To=" + Server.UrlEncode(ToDate)), true);
