...
public partial class Rpt_Campaign_Followup_Detailed : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                lblCampaign_Result.Text = ddlCampaign.SelectedItem.ToString();
                ds = Report.Get_Campaign_Followup_Detailed_Report(1, CreatedBy,ddlCampaign.SelectedValue);                
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Report_Campaign_Followup_Detailed_" + DateTime.Now + ".xls"; ;
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'><TR style='color: #fff; background: black;text-align:center;'><TD>Campaign -" + ddlCampaign.SelectedItem.ToString() + "</TD></TR>");
        Response.Charset = "";
