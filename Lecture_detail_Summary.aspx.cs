...
public partial class Leature_detail_Summary : System.Web.UI.Page
{
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Center Wise Lecture Details" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='9'>Center Wise Lecture Details</TD></TR>");
        Response.Charset = "";
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        if (DateRange.Length != 0)
        {
            ...
            DataSet ds1 = Reporting.GetLecturedetails(CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, a1, a2);
