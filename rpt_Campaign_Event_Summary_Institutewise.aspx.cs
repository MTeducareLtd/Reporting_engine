...
public partial class rpt_Campaign_Event_Summary_Institutewise : System.Web.UI.Page
{
    ...
    protected void ddlReportType_SelectedIndexChanged(object sender, System.EventArgs e)
    {
        ...
        {
            Response.Redirect("Campaign_Event_Summary.aspx");
        }
        else if (ddlReportType.SelectedValue == "Institutewise")
        {
            Response.Redirect("rpt_Campaign_Event_Summary_Institutewise.aspx");
        }
        else if (ddlReportType.SelectedValue == "Agentwise")
        {
            Response.Redirect("rpt_Campaign_Event_Summary_Agentwise.aspx");
        }
    }
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = ProductController.GET_CAMPAIGN_Event_Summary_Institutewise(1, UserID, ddlcampaignacadyear.SelectedValue, Camapign_id);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 =  "Campaign_Event_Summary_Institutewise_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='6'>Campaign Event Summary Institutewise</TD></TR>");
        Response.Charset = "";
