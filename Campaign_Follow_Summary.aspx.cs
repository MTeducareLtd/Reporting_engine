...
public partial class Campaign_Follow_Summary : System.Web.UI.Page
{
    ...
    protected void ddlReportType_SelectedIndexChanged(object sender, System.EventArgs e)
    {
        ...
        {
            Response.Redirect("Campaign_Follow_Summary.aspx");
        }
        else if (ddlReportType.SelectedValue == "Institutewise")
        {
            Response.Redirect("rpt_Campaign_Followup_Summary_Institutewise.aspx");
        }
        else if (ddlReportType.SelectedValue == "Agentwise")
        {
            Response.Redirect("rpt_Campaign_Followup_Summary_Agentwise.aspx");
        }
        else if (ddlReportType.SelectedValue == "Event Agentwise")
        {
            Response.Redirect("rpt_Campaign_Followup_Summary_Event_Agentwise.aspx");
        }
    }
    ...
    private void BindCampaignDetail()
    {
       ...
       // ddlCampaignname.Items.Insert(0, "");
        ddlCampaignname.Items.Insert(0, "All");
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = ProductController.GET_CAMPAIGN_SUMMARY_REPORT
                    (1, CreatedBy, ddlcampaignacadyear.SelectedValue, "", "", Camapign_id);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Campaign_Followup_Summary_" + DateTime.Now + ".xls";
        //if (dlCampaignDetail.Visible == true)
        //{
        //    filenamexls1 = "Campaign_Followup_Summary_" + DateTime.Now + ".xls";
        //}
        //else
        //{
        //    filenamexls1 = "Campaign_Followup_Summary_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='11'>Campaign Followup Summary</TD></TR>");
        Response.Charset = "";
    ...
    protected void dlGridDisplay_ItemCommand(object source, System.Web.UI.WebControls.DataListCommandEventArgs e)
    {
        if (e.CommandName == "Campaign_Detail")
        {
            ...
            try
            {
                ...
                try
                {
                    ds = Report.GetUser_Role_Campaign_Detail(11, CreatedBy, e.CommandArgument.ToString(), ddlCampaignname.SelectedValue, "");
