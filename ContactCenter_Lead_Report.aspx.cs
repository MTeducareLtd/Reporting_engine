...
public partial class ContactCenter_Lead_Report : System.Web.UI.Page
{
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Contact Center Lead Report" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='4'>Contact Center Lead Report</TD></TR>");
        Response.Charset = "";
  ...
  //-- HttpCookie cookie = Request.Cookies.Get("MyCookiesLoginInfo");  
        ...
        DataSet ds1 = Reporting.LeadreportSourcewise(CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, a1, a2);
