...
public partial class Rpt_Subject_Wise_Count : System.Web.UI.Page
{
    int runningTotal = 0;
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        else
        {
            ...
            DataSet ds1 = Reporting.GetSubjectWiseCount(Reporttype, Flag2, CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID, Stream,FromDate,ToDate);
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        ...
        string filenamexls1 = "Subject_Wise_Count" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='10'>Subject Wise Count Report</TD></TR>");
        Response.Charset = "";
    ...
    {
        //Response.Redirect("Rpt_Subject_Wise_Count.aspx");
