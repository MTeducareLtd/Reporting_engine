<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true" CodeFile="RPT_Pending_admission_Resons.aspx.cs" Inherits="RPT_Pending_admission_Resons" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Pending Admission <span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                        ...
                        <div class="tab-content" style="border: 1px solid #DDDDDD">                            
                                ...
                                <ItemTemplate>
                                  <tr class="odd gradeX">                                       
                                        ...
                                        <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="lblCenter1" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Source_Center_Name")%>' />
                                        </td>
                                        <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Zone" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Zone_Name")%>' />
                                        </td>
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label27" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"Stream")%>' />
                                        </td>
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label26" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem,"AcadYear")%>' />
                                        </td>
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri;">
                                            <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Cur_SB_Code")%>' />
                                        </td>
                                        <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label10" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Name")%>' />
                                        </td> 
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label30" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Admission_Date")%>' />
                                        </td> 
                                       <td style="text-align: left; font-size:10.0pt; font-family:Calibri;">
                                            <asp:Label ID="Label7" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"NetFees")%>' />
                                        </td> 
                                        <td style="text-align: left; font-size:10.0pt; font-family:Calibri;">
                                            <asp:Label ID="Label2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"amountoffered")%>' />
                                        </td> 
                                       <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label8" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ChqOutstanding")%>' />
                                        </td> 
                                      <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label9" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"PENDGINSTATUS")%>' />
                                        </td>  <td style="text-align: left; font-size:10.0pt; font-family:Calibri; ">
                                            <asp:Label ID="Label11" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Event_Description")%>' />
                                        </td> 
