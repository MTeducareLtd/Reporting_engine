...
public partial class Rpt_Collection_Count_CenterWise : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        DataSet ds1 = Reporting.GetCollectionCountCenter(Reporttype, Flag2, CompanyCode, DivisionCode, Zonecode, CenterCode, AcadyearCode, UserID);
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        ...
        string filenamexls1 = "Collection_count_centerwise_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri;text-decoration-color: White; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='25'>Collection Count Center Wise Report </TD></TR>");
        Response.Charset = "";
    ...
    {
        Response.Redirect("rpt_collection_count_CenterWise.aspx");
    }
