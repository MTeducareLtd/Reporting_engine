...
public partial class Rpt_Contacts_LocationStandardwise : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        try
        {
            ...
            try
            {
                ds = Report.Get_Contact_LocationStandardWise_Report(1,ddlAcadYear.SelectedValue,StandardCode, CreatedBy);
