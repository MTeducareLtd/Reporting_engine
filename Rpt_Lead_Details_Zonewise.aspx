<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true" CodeFile="Rpt_Lead_Details_Zonewise.aspx.cs" Inherits="Rpt_Lead_Details_Zonewise" %>
                                    ...
                                    <ContentTemplate>
                                        <table cellpadding="6" class="table table-striped table-bordered table-condensed">
                                         ...
                                         <tr>
                                                ...
                                                <td class="span4" style="text-align: center" colspan="3" runat="server" visible="false">
                                ...
                                <FooterTemplate>
                                   <%-- <tr class="odd gradeX"> 
                                       ...
                                       <td style="text-align: center; color: #fff; background: ;"><asp:Label ID="Label5" ForeColor="DarkBlue" runat="server"/></td>
                                        ...
                                        </tbody></table></FooterTemplate></asp:Repeater>
                                ...
                                <FooterTemplate>
                                   <%-- <tr class="odd gradeX"> 
                                       ...
                                       <td style="text-align: center; color: #fff; background: ;"><asp:Label ID="Label5" ForeColor="DarkBlue" runat="server"/></td>
                                        ...
                                        </div></div></div></div><div id="DivPrint" runat="server" visible="true" style="height: 0px; overflow: hidden;">
