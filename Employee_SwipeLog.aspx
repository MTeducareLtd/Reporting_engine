<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.master" AutoEventWireup="true"
    CodeFile="Employee_SwipeLog.aspx.cs" Inherits="Employee_SwipeLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Employee Swipe Log<span  class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                                            ...
                                                            <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                                <tr>
                                                                    <td style="border-style: none; text-align: left; width: 50%;">
                                                                        <asp:Label runat="server" ID="lblrfid">Employee Code</asp:Label>
                                                                    </td>
                                                                    <td style="border-style: none; text-align: left; width: 50%;">
                                            ...
                                            <asp:Repeater ID="Teacherattendance" runat="server">
                                                ...
                                                <ItemTemplate>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label4" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"RFID_Card_ID")%>' />
                                                        </td>
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label5" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"User_Display_Name")%>' />
                                                        </td>
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label26" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Device_Name")%>' />
                                                        </td>
                                                        <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
                                                            <asp:Label ID="Label20" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Log_Time")%>' />
                                                        </td>
                                                         <td style="text-align: left; font-size: 10.0pt; font-family: Calibri;">
